...
+ 액터에 물리적인 힘을 주는 방법
- 기본적인 키는 카메라 조작과 같지만, 스페이스바를 누르면서 조작시에, 카메라가 조작되는 것이 아니라 해당 방향으로 Focus 액터에 힘이 가해지면서 조종 할 수 있습니다!
---
...
---
- ![ShowCollideBox](ShowCollideBox.png)

해당 체크박스를 클릭하면, 물리엔진 상에서, 이 액터의 충돌 범위를 나타냅니다.
충돌의 기준이 되는 박스는 액터가 가지고 있는 모든 메시를 다 담을 수 있는 최소 크기의 직육면체를 기준으로 정해집니다