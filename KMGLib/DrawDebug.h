...
namespace DrawDebug
{
	...
	void DrawLine(std::wstring name, DirectX::XMFLOAT3 start, DirectX::XMFLOAT3 end, DirectX::XMFLOAT4 color, float thickness = 1.0f);
	...
	KMGDebugMesh MakeDebugLine(DirectX::XMFLOAT3 start, DirectX::XMFLOAT3 end, DirectX::XMFLOAT4 color, float thickness = 1.0f);
